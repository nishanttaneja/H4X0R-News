...
This application fetches latest news from "https://news.ycombinator.com/", then parses the result data and displays titles in a UITableView. When a row is selected the source news is displayed as WebView using WebKit.
